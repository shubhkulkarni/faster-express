...
program
  .name('faster-express')
  .description('A production-ready CLI for scaffolding resource-based Express applications')
...
program
  ...
  .option('--boilerplate <level>', 'Boilerplate level (minimal|full|signatures)', 'full')
